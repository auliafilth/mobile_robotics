...
private:
    ...
    std::vector<nav_msgs::Odometry> des_stopping_state_vec_;  // MATT ADDED THIS ONE
    ...
    bool e_stop_reset_;
    int traj_pt_i_;
    int stopping_traj_pt_i_; // MATT ADDED THIS ONE
    int npts_traj_;
    double dt_;
    //dynamic parameters: should be tuned for target system
    double accel_max_; 
...
public:
    ...
    void pub_next_state(bool lidar_alarm);
